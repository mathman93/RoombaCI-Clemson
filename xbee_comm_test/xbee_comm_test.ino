...
// XBee's DOUT (TX, pin 2 of xbee) is connected to pin 12 of Arduino board (Arduino's Software RX)
// XBee's DIN (RX, pin 3 of xbee) is connected to pin 11 of Arduino board (Arduino's Software TX)
