		...
		while spin_value != 0: # If the Roomba needs to turn...
			try:
				...
				if (time.time() - query_base) > query_timer: # Every (query_timer) seconds...
					...
					print("{0:.5f}, {1:.3f}, {2:.3f}, {3:.3f}, {4:.3f}, {5}, {6}, {7:.3f}, {8:.3f};".format(data_time, distance, desired_distance, angle, desired_heading, l_counts, r_counts, y_pos, x_pos))
